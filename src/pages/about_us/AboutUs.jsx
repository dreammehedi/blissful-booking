...
import clients1 from "../../assets/clients/clients1.avif";
import clients10 from "../../assets/clients/clients10.jpg";
import clients11 from "../../assets/clients/clients11.jpg";
...
function AboutUs() {
  return (
    <>
      <Helmet>
        <title>Blissful Booking | About US</title>
      </Helmet>
      <section className="py-8 lg:py-10 bg-white dark:bg-gray-900">
        ...
        <div className="container py-8 md:py-12">
          ...
          <SectionTitle
            ...
            description="At Blissfull Booking, we believe in giving back to the communities we serve. Through our various initiatives and partnerships, we strive to make a positive impact on the lives of those around us. From sponsoring local events to volunteering our time and resources, we are committed to supporting causes that matter."
          ></SectionTitle>
